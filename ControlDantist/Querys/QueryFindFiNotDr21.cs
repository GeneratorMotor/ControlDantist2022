...
{
    public class QueryFindFiNotDr21 : IQuery
    {
        // Фамилия льготника.
        ...
        public QueryFindFiNotDr21(string firstName, string name, int yearValid)
        {
        ...
        public string Query()
        {
            string query = @" declare @FistName nvarchar(100)
                   ...
                   @"select Фамилия, Имя, ДоговорАрхив.НомерДоговора,ДатаДоговора,[НомерАкта],
                                                ДатаАктаВыполненныхРаботАрхив,
                                                ДоговорАрхив.flagАнулирован,ДоговорАрхив.ФлагАнулирован, ФлагПроверкиАрхив,ФлагНаличияАкта from ДоговорАрхив
