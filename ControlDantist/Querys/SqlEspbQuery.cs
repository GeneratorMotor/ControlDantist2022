...
{
    public class SqlEspbQuery : IQuery
    {
        public string Query()
        {
            return @" select ESPB_PERSONAL_CARD.SNILS as 'СНИЛС',ESPB_ENTITLING_DOCUMENT.DOCUMENT_SERIES as 'СерияДокумента',
                    ...
                    where ESPB_ENTITLING_DOCUMENT.DATE_EXPIRATION is null  ";
        }
    }
}
