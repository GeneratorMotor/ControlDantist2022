...
{
    /// <summary>
    /// Устанавливает договор как не прошедший проверку.
    /// </summary>
    public class SqlSetFalseValidate : IQuery
    {
        private string user = string.Empty;
        private string date = string.Empty;
        private int idContract = 0;

        public SqlSetFalseValidate(string user, string date, int idContract)
        {
