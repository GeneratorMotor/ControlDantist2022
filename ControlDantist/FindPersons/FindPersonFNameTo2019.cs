...
{
    public class FindPersonFNameTo2019 : IFindPerson
    {
        private string firstName = string.Empty;

        public FindPersonFNameTo2019(string firstName)
        {
        ...
        public string Query()
        {
            string query = @"declare @firstName nchar(100)
                            ...
                            and YEAR(ДоговорАрхив.ДатаЗаписиДоговора) < 2019 and АктВыполненныхРаботАрхив.НомерАкта is not null
