...
{
    /// <summary>
    /// Поиск льготников прошедших проврку в 2021 и более поздних годах (в светолм будущем).
    /// </summary>
    public class FindPersonAftar : IFindPerson
    {
        string numContract = string.Empty;

        private bool flagValid = false;

        public FindPersonAftar(string numContract, bool flagValid)
        {
        ...
        public string Query()
        {
            string query = "declare @numContract nchar(100) " +
                            ...
                            where Договор.ФлагПроверки = '" + this.flagValid + "' " +
